      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Start building your SaaS blueprint for free
          </p>
        </div>
                    ...
                    {PASSWORD_REQUIREMENTS.map((req) => {
                      ...
                      return (
                        <div key={req.label} className="flex items-center gap-2">
                          <div className={`h-3.5 w-3.5 rounded-full flex items-center justify-center ${passed ? "bg-emerald-500" : "bg-border"}`}>
                            {passed && <Check className="h-2 w-2 text-white" />}
                          </div>
                          <span className={`text-xs ${passed ? "text-emerald-400" : "text-muted-foreground"}`}>
                            {req.label}
                          </span>
                        </div>
                      );
